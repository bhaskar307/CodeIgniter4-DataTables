            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <span class="d-none d-xl-inline-block ms-1"
                        key="t-henry"><?= getBackUser()?->full_name ?? NULL ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="<?= base_url('portal/update-profile') ?>"><i
                            class="bx bx-user font-size-16 align-middle me-1"></i>
                        <span key="t-profile">Profile</span></a>
                    <a class="dropdown-item" href="<?= base_url('portal/change-password') ?>"><i
                            class="bx bx-lock-open-alt font-size-16 align-middle me-1"></i>
...
<header class="app-topbar" id="page-topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="index.html" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="<?= base_url('back/images/logo.png') ?>" alt="logo"></span>
                    <span class="logo-sm"><img src="<?= base_url('back/images/logo-sm.png') ?>" alt="small logo"></span>
                </span>

                <span class="logo-dark">
                    <span class="logo-lg"><img src="<?= base_url('back/images/logo-dark.png') ?>" alt="dark logo"></span>
                    <span class="logo-sm"><img src="<?= base_url('back/images/logo-sm.png') ?>" alt="small logo"></span>
                </span>
            </a>
            ...
            <div class="topbar-item">
                <div class="dropdown">
                    <button class="topbar-link" data-bs-toggle="dropdown" data-bs-offset="0,25" type="button"
                        ...
                        <img src="<?= base_url('back/images/flags/us.svg') ?>" alt="user-image" class="w-100 rounded" height="18"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="en">
                            <img src="<?= base_url('back/images/flags/us.svg') ?>" alt="user-image" class="me-1 rounded" height="18"
                                data-translator-image> <span class="align-middle">English</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi">
                            <img src="<?= base_url('back/images/flags/in.svg') ?>" alt="user-image" class="me-1 rounded" height="18"
                                data-translator-image> <span class="align-middle">Hindi</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= base_url('back/images/flags/de.svg') ?>" alt="user-image" class="me-1 rounded" height="18">
                            <span class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= base_url('back/images/flags/it.svg') ?>" alt="user-image" class="me-1 rounded" height="18">
                            <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= base_url('back/images/flags/es.svg') ?>" alt="user-image" class="me-1 rounded" height="18">
                            <span class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?= base_url('back/images/flags/ru.svg') ?>" alt="user-image" class="me-1 rounded" height="18">
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg fs-13">
                        ...
                        <div class="position-relative z-2 shadow-none rounded-0" style="max-height: 300px;"
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                <span class="d-flex align-items-center">
                                    <span class="me-2 position-relative flex-shrink-0">
                                        <img src="<?= base_url('back/images/users/avatar-4.jpg') ?>" class="avatar rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                <span class="d-flex align-items-center">
                                    <span class="me-2 position-relative flex-shrink-0">
                                        <img src="<?= base_url('back/images/users/avatar-7.jpg') ?>" class="avatar rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                            ...
                            <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                <span class="d-flex align-items-center">
                                    <span class="me-2 position-relative flex-shrink-0">
                                        <img src="<?= base_url('back/images/users/avatar-10.jpg') ?>" class="avatar rounded-circle"
                                            alt="" />
                                    </span>
                                    <span class="flex-grow-1 text-muted">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0">
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/slack.svg') ?>" alt="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/gitlab.svg') ?>" alt="Github">
                                        <span>Gitlab</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/dribbble.svg') ?>" alt="dribbble">
                                        <span>Dribbble</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/bitbucket.svg') ?>" alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/dropbox.svg') ?>" alt="dropbox">
                                        <span>Dropbox</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="<?= base_url('back/images/brands/google-cloud.svg') ?>" alt="G Suite">
                                        <span>G Cloud</span>
                                    </a>
                                </div>
                            </div> <!-- end row-->
            ...
            <div class="topbar-item nav-user">
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <img src="<?= base_url('back/images/users/avatar-1.jpg') ?>" width="32" class="rounded-circle me-lg-2 d-flex"
                            alt="user-image">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?= base_url('portal/logout') ?>" class="dropdown-item active fw-semibold text-danger">
